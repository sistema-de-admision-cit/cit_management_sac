...
import AddQuestion from '../../questions/add_questions/organisms/AddQuestion'
...
const menuConfig = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        path: '/examenes',
        subItems: [
          { key: 'ingresar', label: 'Ingresar Preguntas', path: '/examenes/ingresar', component: AddQuestion },
