...
const GuardianInfo = ({ guardian }) => (
  <div className='tab-content'>
    ...
    <p><strong>Nombre:</strong> {guardian.person.firstName} {guardian.person.firstSurname} {guardian.person.secondSurname}</p>
    <p><strong>Tipo de ID:</strong> {guardian.person.idType}</p>
    <p><strong>Número de ID:</strong> {guardian.person.idNumber}</p>
