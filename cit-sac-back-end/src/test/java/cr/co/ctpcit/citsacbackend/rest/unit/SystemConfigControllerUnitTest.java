...
import cr.co.ctpcit.citsacbackend.rest.config.SystemConfigController;
...
public class SystemConfigControllerUnitTest {
  ...
  void setUp() throws Exception {
    ...
    notifications = Arrays.asList(
            new SystemConfigEntity(1, "email_contact", "complejoEducativo@ctpcit.com"),
            new SystemConfigEntity(2, "email_notifications_contact", "notificacionesCIT@ctpcit.com"),
  ...
  void updateNotifications() throws Exception {
    List<SystemConfigEntity> updatedNotifications = Arrays.asList(
            new SystemConfigEntity(1, "email_contact", "complejoEducativo@ctpcit.com"),
            new SystemConfigEntity(2, "email_notifications_contact", "notificacionesCIT@ctpcit.com"),
            new SystemConfigEntity(3, "whatsapp_contact", "88950252"),
            new SystemConfigEntity(4, "office_contact", "22370186"),
    ...
    doNothing().when(systemConfigService).updateNotifications(
    ...
    mockMvc.perform(put("/api/system-config/update-notifications")
                    .param("email_contact", "complejoEducativo@ctpcit.com")
                    .param("email_notifications_contact", "notificacionesCIT@ctpcit.com")
                    .param("whatsapp_contact", "88950252")
                    .param("office_contact", "22370186")
