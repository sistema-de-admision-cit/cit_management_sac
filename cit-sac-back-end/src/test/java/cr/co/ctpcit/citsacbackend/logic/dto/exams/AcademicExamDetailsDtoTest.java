...
class AcademicExamDetailsDtoTest {
  ...
  @Test
  void deserializeAcademicExamDto() throws IOException {
    String json  = """
        {
          "id": 1,
          "grade": 100.00,
    ...
    AssertionsForClassTypes.assertThat(tester.parseObject(json).exam().responses().size())
        .isEqualTo(exam.exam().responses().size());
  }
}
