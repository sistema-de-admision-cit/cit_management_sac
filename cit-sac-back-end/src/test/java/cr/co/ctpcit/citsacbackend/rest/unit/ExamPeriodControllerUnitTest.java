...
public class ExamPeriodControllerUnitTest {
  ...
  void getAllExamPeriods() throws Exception {
    ...
    mockMvc.perform(
            get("/api/exam-periods").header("Authorization", "Bearer " + authResponseDto.token())
  ...
  void createExamPeriod() throws Exception {
    ...
    mockMvc.perform(
            post("/api/exam-periods").header("Authorization", "Bearer " + authResponseDto.token())
  ...
  void updateExamPeriod() throws Exception {
    ...
    mockMvc.perform(
            put("/api/exam-periods/1").header("Authorization", "Bearer " + authResponseDto.token())
                .contentType(MediaType.APPLICATION_JSON).content(
                    "{\"examPeriodId\":1,\"startDate\":\"2024-09-01T00:00:00.000+00:00\",\"endDate\":\"2024-09-10T00:00:00.000+00:00\"}"))
