...
public class QuestionsAcademicController {
    ...
    public ResponseEntity<List<AcademicQuestionsDto>> getAllExamQuestions() {
        List<AcademicQuestionsDto> examQuestions = academicQuestionsServiceimplementation.obtenerTodasLasPreguntas();
    ...
    public ResponseEntity<AcademicQuestionsDto> getExamQuestionById(@PathVariable Integer id) {
        AcademicQuestionsDto examQuestion = academicQuestionsServiceimplementation.obtenerPreguntaPorId(id);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<AcademicQuestionsDto> updateExamQuestion(@PathVariable Integer id, @RequestBody AcademicQuestionsDto preguntaDto) {
        AcademicQuestionsDto updatedQuestion = academicQuestionsServiceimplementation.modificarPregunta(id, preguntaDto);
