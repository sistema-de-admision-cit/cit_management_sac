 ...
 */
public record AcademicQuestionsDto(
        @NotNull Integer id,
        @NotNull String questionText,
        @NotNull Grades questionGrade,
        @NotNull String option_A,
        @NotNull String option_B,
        @NotNull String option_C,
        @NotNull String option_D,
        @NotNull String correctOption,
        String imageUrl
