...
public interface ParentGuardianStudentRepository
    extends JpaRepository<ParentGuardianStudentEntity, ParentGuardianStudentEntityId> {

  Optional<ParentGuardianStudentEntity> findParentGuardianStudentEntityByStudentAndParentGuardian(
      StudentEntity studentEntity, ParentsGuardianEntity parent);
}
