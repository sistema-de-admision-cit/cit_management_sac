...
/**
 * Mapper for {@link ExamPeriodEntity}
 * This class is used to convert an {@link ExamPeriodEntity} to an {@link ExamPeriodDto}
*/
...
public class ExamPeriodMapper {
    ...
    public static List<ExamPeriodDto> convertToDtoList(List<ExamPeriodEntity> examPeriods) {
        return examPeriods.stream()
                .map(ExamPeriodMapper::convertToDto)
                .toList();
    }
}
