...
INSERT INTO `db_cit_test`.`tbl_systemconfig` (`config_name`, `config_value`) VALUES ('email_contact', 'contactocit@ctpcit.com');
INSERT INTO `db_cit_test`.`tbl_systemconfig` (`config_name`, `config_value`) VALUES ('email_notifications_contact', 'notificaciones@ctpcit.com');
